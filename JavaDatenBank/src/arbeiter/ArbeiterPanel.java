 ...
 * @author user
 */
public class ArbeiterPanel extends javax.swing.JDialog {
    DefaultTableModel model;
    ArbeiterEingabe islemler =  new ArbeiterEingabe();
    
    
    /**
     * Creates new form CalisanEkrani
     */
    public ArbeiterPanel(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void calisanGoruntule() {
        ...
        ArrayList<Arbeitern> calisanlar = new ArrayList<Arbeitern>();
        ...
        if (calisanlar != null ) {
            ...
            for (Arbeitern arbeitern : calisanlar) {
                Object[] eklenecek = {arbeitern.getId(),arbeitern.getAd(),arbeitern.getSoyad(),arbeitern.getDepartman(),arbeitern.getMaas()};
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ArbeiterPanel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ArbeiterPanel dialog = new ArbeiterPanel(new javax.swing.JFrame(), true);
