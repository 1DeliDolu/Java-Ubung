 ...
 * @author user
 */
public class EingabePanel extends javax.swing.JFrame {
    ...
    private void girisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_girisActionPerformed
        ...
        if (girisbasarili) {
            ArbeiterPanel calisanEkrani = new ArbeiterPanel(this,true);
            setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EingabePanel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EingabePanel().setVisible(true);
            }
        });
    }
